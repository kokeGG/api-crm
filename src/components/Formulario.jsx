  ...
  return (
    cargando? <Spinner/> : (
        ...
        md:w-3/4 mx-auto'>
            ...
            <Formik
                initialValues={{
                    nombre: cliente?.nombre ?? "", //si hay informacion de cliente nombre se utiliza, sino, es una cadena vacía
                ...
                >
                    <div className='mb-4'>
                        ...
                        <Field
                            id="nombre"
                            type="text"
                            className="mt- block w-full p-3 bg-gray-50"
                    ...
                    <div className='mb-4'>
                        ...
                        <Field
                            ...
                            id="notas"
                            type="text"
                            className="mt- block w-full p-3 bg-gray-50 h-40"
